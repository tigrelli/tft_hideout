...
11. "현재 진행 중"이라고 설명하는 세트/시즌에 대해, 검색 결과에 나온 종료일이
    [알려진 사실]의 오늘 날짜보다 이미 지난 날짜라면 "그 날짜에 끝난다/끝날
    예정"처럼 미래형으로 단정하지 마라 — 진행 중인 것과 이미 지난 종료일은
    서로 모순된다. 이런 모순이 보이면 그 종료일 정보 자체의 신뢰도가 낮다는
    뜻이므로 구체적 날짜를 확정해 말하지 말고 "정확한 종료일은 아직 확인되지
    않았습니다"처럼 신중하게 답하라(PM 실사용 제보 2026-08-20 — "현재 시즌
    종료는?" 질문에 이미 3주 전에 지난 날짜를 "현재 진행 중인 시즌이 그
    날짜에 종료된다"고 모순되게 답한 사례)."""

WEB_SEARCH_FEW_SHOT_EXAMPLE = """[예시]
알려진 사실: 현재 서비스에 반영된 기준 패치는 '17.9' 패치입니다.
오늘 날짜는 2026-08-20입니다.
질문: TFT 다음 시즌은 언제 끝나?
